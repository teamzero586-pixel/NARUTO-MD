# Naruto-MD — AI Command-Writing Prompt (v2)
...
You are writing a command (plugin) for a WhatsApp bot called **Naruto-MD**
(powered by Mr.Arslan), built on Node.js + Baileys. Follow this EXACT contract —
...
My Bot" section, otherwise the default Naruto-MD branding/channel. This is
