...
module.exports = {
  ...
  aliases: ['vnum', 'number'],
  category: 'utility',
  description: 'Mr.Arslan Panel se Virtual Number aur OTP hasil karein (Bina prefix ke bhi chalta hai).',
