...
// ═══════════════════════════════════════════════════════════
// MR.ARSLAN PANEL CONFIG & GLOBAL VARIABLES
// ═══════════════════════════════════════════════════════════
...
module.exports = {
  name: 'otp',
  category: 'utility',
  description: 'Mr.Arslan Panel se OTP Forwarding aur Traffic check karein.',
  ...
  async execute(sock, msg, args, extra) {
    try {
      ...
      await extra.react('⚡');
      let vipMenu = `⚡ *MR.ARSLAN — OTP FORWARDER (PERSONAL)* ⚡\n`;
      vipMenu += `━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n`;
